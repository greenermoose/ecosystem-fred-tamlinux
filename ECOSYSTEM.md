...
|---|---|---|
| [omarchy-fred-config](https://github.com/greenermoose/config-fred-tamlinux) (private) | all four | the workstation itself; `omawrite-review` (how agents show Fred their plans) hard-depends on the omawrite patches |
