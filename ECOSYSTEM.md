...
| [hyprland](packages/hyprland/README.md) | active | `0.56.2-3.2` | [v0.56.2-fred.2](https://github.com/hyprwm/Hyprland/compare/v0.56.2...greenermoose:Hyprland:v0.56.2-fred.2) | 2 | [hyprwm/Hyprland/pull/16290](https://github.com/hyprwm/Hyprland/pull/16290) | an Arch hyprland release containing both fixes (onConnect() honours the compositor DPMS state; setInhibit() guards the unchanged case). If only one lands, drop that patch and rebuild as <arch>.1 | omarchy-fred-config, omarchy-fred-workspaces, fred.monitor (planned) |
