...
| [omarchy](packages/omarchy/README.md) | active | `4.0.4-1.2` | [v4.0.4-fred.2](https://github.com/basecamp/omarchy/compare/v4.0.4...greenermoose:omarchy:v4.0.4-fred.2) | 2 | — | Omarchy ships a release after 4.0.4 whose bar tooltip both reserves border in padding and sizes the popup so logical size × DPR is an integer physical pixel count; then retire via omarchy-fred-ecosystem retire omarchy | omarchy-fred-config, fred.agents, fred.monitor, fred.sysinfo, fred.clock, fred.workspaces |
<!-- registry:end -->
