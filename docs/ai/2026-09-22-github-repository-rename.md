...
- **Change**: GitHub repository `omarchy-fred-ecosystem` became `ecosystem-fred-tamlinux`; local origin and current README, manifest, and other active repository links were updated. Local checkout paths remain unchanged.
